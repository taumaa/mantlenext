...
import {ownerAddress} from "@/const";
...
const Mint = () => {
    ...
    return (
        <div className="justify-between flex lg:flex-row flex-col py-32">
                ...
                <div className="-mb-8">
                    ...
                    { !!humanReadableSupply && !isLoadingSupply && (
                        <div className="mt-6 text-white text-sm">
                            Minted: {humanReadableSupply}/<span className="text-3xl">&infin;</span>
                        </div>
                    )}
                    {!humanReadableSupply && (
                        <div className="mt-3 text-white text-sm">
                            Minted: .../<span className="text-3xl">&infin;</span>
                        </div>
                    )}
